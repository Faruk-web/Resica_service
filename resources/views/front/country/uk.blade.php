            ...
            <div class="col-lg-4 ttm-col-bgcolor-yes cmt-bg cmt-left-span cmt-bgcolor-grey mt_80 pt-60 mb_80 pb-60 res-991-mt-0 res-991-pt-0 widget-area sidebar-left">
                ...
                <aside class="widget widget-nav-menu">
                    <ul class="widget-menu">
                        ...
                        <li class="active"><a href="usa.html">USA</a></li>
                    </ul>
                </aside>
            ...
            <div class="col-lg-8 content-area">
                <div class="cmt-service-single-content-area">
                    <div class="cmt-featured-wrapper mb-40 res-991-mb-20">
                        <img class="img-fluid" src="{{asset('/')}}front/assets/images/country/country-details_04.jpg" alt="">
                    </div>
                    <div class="cmt-service-description">
                        <h4>Study, Work, Live in United States</h4>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged</p>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="ttm_single_image-wrapper mt-20">
                                    <img class="img-fluid" src="{{asset('/')}}front/assets/images/single-img-14.jpg" alt="single_14">
                                </div>
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="mt-30">
                            <h4>Study, Work, Live in United States Benifits</h4>
