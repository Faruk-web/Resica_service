            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <div class="page-title-heading">
                        <h2 class="title">Business Visa</h2>
            ...
            <div class="col-lg-4 ttm-col-bgcolor-yes cmt-bg cmt-left-span cmt-bgcolor-grey mt_80 pt-60 mb_80 pb-60 res-991-mt-0 res-991-pt-0 widget-area sidebar-left">
                ...
                <aside class="widget widget-nav-menu">
                    <ul class="widget-menu">
                        <li class="active"><a href="business-visa.html">Business Visa</a></li>
                            ...
                            <div class="row cmt-vertical_sep">
                                    ...
                                    <div class="cmt-fid inside cmt-fid-with-icon cmt-fid-view-lefticon">
                                        ...
                                        <div class="cmt-fid-contents">
                                            <h4 class="cmt-fid-inner">
                                                <span data-appear-animation="animateDigits" data-from="0" data-to="15" data-interval="3" data-before="" data-before-style="sup" data-after="" data-after-style="sub" class="numinate">15
                                                </span>
                                                <sub>+</sub>
                                            </h4>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 cmt-box-col-wrapper">
                                    ...
                                    <div class="cmt-fid inside cmt-fid-with-icon cmt-fid-view-lefticon">
                                        ...
                                        <div class="cmt-fid-contents">
                                            <h4 class="cmt-fid-inner">
                                                <span data-appear-animation="animateDigits" data-from="0" data-to="1490" data-interval="15" data-before="" data-before-style="sup" data-after="" data-after-style="sub" class="numinate">1490
                                                </span>
                                                <sub>+</sub>
                                            </h4>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 cmt-box-col-wrapper">
                                    ...
                                    <div class="cmt-fid inside cmt-fid-with-icon cmt-fid-view-lefticon">
                                        ...
                                        <div class="cmt-fid-contents">
                                            <h4 class="cmt-fid-inner">
                                                <span data-appear-animation="animateDigits" data-from="0" data-to="850" data-interval="15" data-before="" data-before-style="sup" data-after="" data-after-style="sub" class="numinate">850
                                                </span>
                                                <sub>+</sub>
                                            </h4>
